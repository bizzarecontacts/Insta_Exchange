# Don't judge the book by it's content ;) 
#25/01/2021
#Modified & Tested By David Dvir
#https://github.com/bizzarecontacts
# Run on Exchange Server Verion 2013/2016/2019 to Detect Hafnium webshells.
...
if ($Files.length -eq 0) {
  ...
  Write-Host "ATTENTION! Webshells Probably Found." -fore red
}
Write-Host
